...
<table class="main">
    <tbody>
        <tr>
            ...
            <td width="45%" align="center">
                <div>
                <h2>Their item isn't here?</h2>
                <input type="button" value="Create Inquiry" onclick="openFoundIn()">
                </div>
            </td>
        </tr>
    </tbody>
...
function openFoundIn() {
    window.open("limbo-found-2.php")
}
</script>