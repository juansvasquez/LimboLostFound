...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="styleSheetFOUND.css">
</head>
...
<ul>
    ...
    <li><button>Found Something?</button></li>
    <li><input type="button" value="Admins" onclick="openAdmins()"></li>
</ul>
</div>
<!-- 
The main section of the page for limbo-found where the form is.
This includes all components of description and the sumbit button.
-->
<div class="main">
    <h1>Report Something Found</h1>
    <form action="limbo-found-2.php" method="POST">
        <p>
        ...
        <p>
            Time Found:  <input type="text" name="limbo_time" placeholder="HH:MM:SS" value="<?php if(isset($_POST['limbo_time'])) echo $_POST['limbo_time']; ?>">
        </p>
        <p>
            Date Found: <input type="text" name="limbo_date" placeholder="YYYY-MM-DD" value="<?php if(isset($_POST['limbo_date'])) echo $_POST['limbo_date']; ?>">
        </p>
        <p>
        ...
        <p>
            ...
            <?php
                ...
                if ($_SERVER[ 'REQUEST_METHOD' ] == 'POST') {
                    ...
                    insert_found_item($dbc, $location_id, $description, $model, $color, $limbo_date, $limbo_time, $item, $contact_email, $contact_phone);
